...
samarbeidspartner: ['Ihuga arkitekter']
...
<ArrowLink ekstern={true} text='Lokalsak: Kragerø skal bli mer innbyggerstyrt: – Har pekt ut ti områder' url='https://duckduckgo.com'/>

<ArrowLink ekstern={true} text='Lokalsak: Denne gjengen er klar for en uke med aktiviteter i sentrum: – Målet er å gjøre ting man ikke er vant med' url='https://duckduckgo.com'/>

<ArrowLink ekstern={true} text='Lokalsak: Testuka til Gnist-prosjektet har gått over all forventing: – Vi er overveldet' url='https://duckduckgo.com'/>

<ArrowLink ekstern={true} text='Kronikk: Kan vi lage noe nytt for å snakke om noe nytt?' url='https://duckduckgo.com'/>